...
\begin{frame}{Rozsekání obrázků}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{.5\textwidth}
            \includegraphics[width=0.9\textwidth]{images/snippet_main_splitter.png}
        \end{column}
   \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.45\textwidth}
            \begin{itemize}
                ...
                \item pro reálný program to nebylo nutné
                \item metodou rozsekání lze zpřesnit souřadnice
            \end{itemize}
        \end{column}
        \begin{column}{.5\textwidth}
            \includegraphics[width=1.0\textwidth]{images/snippet_split_class.png}
        \end{column}
   \end{columns}
\end{frame}
