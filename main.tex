...
\title[Wanted: Shadows (\#5590762)]{Wanted: Shadows (\#5590762)}
...
\begin{frame}[plain]
\fullsizegraphic{images/intro_final.png}
\end{frame}
...
\begin{frame}{V čem soutěžíme?}
  \begin{columns}[T]
    ...
    \begin{column}{.6\textwidth}
    \begin{itemize}
        \item mezinárodní soutěž Astro Pi pořádaná \alert{Evropskou vesmírnou agenturou} a \alert{Raspberry Pi Foundation}
...
\begin{frame}{Jak vypadá fotka}
    \begin{center}
        \includegraphics[height=0.8\textheight]{images/ocekavame_obr.jpg}      
    \end{center}
\end{frame}
\begin{frame}{Detailní pohled na mraky}
    \begin{center}
        \includegraphics[height=0.8\textheight]{images/ocekavané výřez.jpg}      
    \end{center}
\end{frame}
\begin{frame}{Trigonometrie}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{images/Prezentace-2.png}      
    \end{center}
\end{frame}
\begin{frame}{\texttt{Shadows not found}}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{images/typy mraku.png}      
    \end{center}
\end{frame}
...
\begin{frame}{OpenCV a Sever vůči ISS}
    ...
    \begin{itemize}
        \item sever na fotce $\rightarrow$ slunce na fotce $\rightarrow$ směr ke stínům
    \end{itemize}
\end{frame}
...
\begin{frame}{Ukázka z testování}
    \begin{columns}[T]
       \begin{column}{.5\textwidth}
        \includegraphics[width =\textwidth]{images/sch1.jpg}
       \end{column}
       \begin{column}{.5\textwidth}
       \includegraphics[width =\textwidth]{images/sch2.jpg}
       \end{column}
   \end{columns}
\end{frame}
...
\begin{frame}{Vlákno generativní}
    \begin{columns}[T]
       ...
       \end{column}
   \end{columns}
   \footnotetext[15]{metadata, obsahující informace o poloze a čase, ukládá se přímo do fotografie}
\end{frame}
...
\begin{frame}{Jak rozřezávání zrychlý program?}
    \begin{itemize}
...
\begin{frame}{Originální fotka}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{images/ukazka_origanal.jpg}
    \end{center}
\end{frame}

\begin{frame}{Otočení fotky}
    \begin{center} 
        \includegraphics[width=0.85\textwidth]{images/ukazka_otocena.jpg}
    \end{center}
\end{frame}

\begin{frame}{Oříznutí fotky}
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            \includegraphics[width=1\textwidth]{images/ukazka_crop.jpg}
        \end{column}
        \begin{column}{.5\textwidth}
            \includegraphics[width=1\textwidth]{images/snippet_split_crop.png}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Rozřezání fotky}
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            \includegraphics[width=1\textwidth]{images/ukazka_chop.jpg}
        \end{column}
        \begin{column}{.5\textwidth}
            \includegraphics[width=1\textwidth]{images/snippet_split_class.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[plain,c]
    ...
    \\
    \vspace{3mm}
    \huge{Nyní je prostor pro dotazy!}
    \\
    \end{center}
    \vspace{3mm}
    \begin{columns}[T]
        \begin{column}{.7\textwidth}
            \begin{center}
                \qrcode[height=3cm]{https://github.com/MMatty8137/astrox/tree/release}
                \\
                \vspace{1mm}GitHub
            \end{center}
        \end{column}
        ...
        \begin{column}{.3\textwidth}
            \begin{center}
                \qrcode[height=3cm]{https://app.sli.do/event/7vYm6tKtEEawjiSR8zCykh}
                \\
                \vspace{1mm}Q\&A
            \end{center}
        \end{column}
...
\vfill
Všechny obrázky byly buď naše nebo CC.
\end{frame}
