...
\begin{frame}{Quō vādis ISS aneb OpenCV: natočení kamery}
    \begin{columns}[T]
        \begin{column}{.7\textwidth}
            \begin{itemize}
    ...
    \begin{columns}[T]
        \begin{column}{.45\textwidth}
            \begin{itemize}
                ...
                \item pokud ještě neuběhlo 256 vteřin tak se loop neukončí ani kdyby byla podmínka splněna
            \end{itemize}
        \end{column}
        \begin{column}{.5\textwidth}
...
\begin{frame}{Kdy nehledat}
    \begin{itemize}
        \item slunce pod 5\degree $rightarrow$ špatná kvalita
    ...
    \begin{columns}[T]
       \begin{column}{.7\textwidth}
           \begin{itemize}
               ...
               \item vytvoříme pětistránkovou zprávu 
           \end{itemize}
       \end{column}
       \begin{column}{.3\textwidth}
