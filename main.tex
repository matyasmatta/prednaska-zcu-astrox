...
\subsection[vysvětlivky]{Dlouhý název podsekce 1}
    ...
    \begin{columns}[T]
       \begin{column}{.45\textwidth}
           \begin{itemize}
               ...
               \item hlavní součástí je tzv. Edge TPU\footnotemark
       ...
       \end{column}
   \end{columns}
   \footnotetext{Tensor Processing Unit, integrovaný obvod pro AI}
\end{frame}
