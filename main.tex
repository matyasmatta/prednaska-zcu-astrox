...
\begin{frame}
    \includegraphics[width=1.0\textwidth]{images/ukazka_origanal.jpg}
\end{frame}

\begin{frame}
    \includegraphics[width=1.0\textwidth]{images/snippet_split_rotate.png}
    \includegraphics[width=0.8\textwidth]{images/ukazka_otocena.jpg}
\end{frame}
