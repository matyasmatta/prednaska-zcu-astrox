    ...
    \begin{columns}[T]
       \begin{column}{.45\textwidth}
           \begin{itemize}
               ...
               \item jedno vlánko na zpracování dat
...
\begin{frame}[c]
    \begin{center}
    \color{mubeamer@base}
    \Huge \textbf{Hlavní zpracovací proces}
    \end{center}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.45\textwidth}
            \begin{itemize}
                ...
                \item ty metadata jsme tam sami zapsali
                \item funkce \texttt{file\_split} obrázek ořízne, rozseká a ke každému chopu přiřadí přesnější souřadnice 
            \end{itemize}
        \end{column}
        \begin{column}{.5\textwidth}
