...
\begin{frame}{Sever vůči ISS}
    \begin{itemize}
        \item dá se zjistit pomocí sférického trojúhelníku
    \end{itemize}
    \begin{center}
...
\begin{frame}{OpenCV: natočení kamery}
    \begin{columns}[T]
        \begin{column}{.7\textwidth}
            \begin{itemize}
                \item fotka může být pootočená 
            \end{itemize}
            \begin{center}
                \includegraphics[width=1\textwidth]{images/open_sever.jpg}
                \includegraphics[width=1\textwidth]{images/opencv_pohyb.jpg}
            \end{center}
            \begin{center}
                \includegraphics[width=1\textwidth]{images/opencv_random.jpg}
            \end{center}
        \end{column}
        \begin{column}{.3\textwidth}
            \begin{center}
                \includegraphics[width=1\textwidth]{images/opencv_britanie.png}  
            \end{center}
        \end{column}
    \end{columns}
    \begin{itemize}
